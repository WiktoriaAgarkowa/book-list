...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _counter__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../counter */ \"./src/app/counter.js\");\n/* harmony import */ var _table_buttons__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../table/buttons */ \"./src/app/table/buttons.js\");\n\n\nvar form = document.querySelector('form');\nvar list = document.getElementById('book_list');\nvar sortPriority = document.querySelector('.sort_priority');\n\nvar addBook = function addBook(e) {\n  e.preventDefault();\n  var title = document.getElementById('title');\n  var author = document.getElementById('author');\n  var category = document.getElementById('category');\n  var radios = document.getElementsByName('priority');\n\n  for (var i = 0, length = radios.length; i < length; i++) {\n    if (radios[i].checked) {\n      var newBook = {\n        id: Date.now(),\n        title: title.value,\n        author: author.value,\n        category: category.value,\n        priority: radios[i].value\n      };\n      var trElement = document.createElement('tr');\n      trElement.innerHTML = \" <td>\".concat(newBook.title, \"</td><td> \").concat(newBook.author, \"</td> <td>\").concat(newBook.category, \"</td> <td> \").concat(newBook.priority, \"</td>\");\n      list.append(trElement);\n      sortPriority.disabled = false; //LOCALSTORAGE\n\n      var bookArray = JSON.parse(localStorage.getItem('allBooks'));\n      if (bookArray == null) bookArray = [];\n      localStorage.setItem('book', JSON.stringify(newBook));\n      bookArray.push(newBook);\n      localStorage.setItem('allBooks', JSON.stringify(bookArray));\n      (0,_table_buttons__WEBPACK_IMPORTED_MODULE_1__.buttons)(newBook.id, trElement); //CLEAR FIELDS\n\n      title.value = '';\n      author.value = '';\n      break;\n    }\n  }\n\n  (0,_counter__WEBPACK_IMPORTED_MODULE_0__.counter)();\n};\n\nvar validateForm = function validateForm(e) {\n  e.preventDefault();\n\n  if (title.value === '') {\n    title.classList.add('error');\n  }\n\n  if (author.value === '') {\n    author.classList.add('error');\n  } else {\n    author.classList.remove('error');\n    title.classList.remove('error');\n    addBook(e);\n  }\n};\n\nform.addEventListener('submit', validateForm);\n\n//# sourceURL=webpack://webpack-tutorial/./src/app/form/form.js?");

/***/ }),

/***/ "./src/app/global_variables.js":
/*!*************************************!*\
  !*** ./src/app/global_variables.js ***!
  \*************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"list\": () => (/* binding */ list),\n/* harmony export */   \"bookArray\": () => (/* binding */ bookArray)\n/* harmony export */ });\nvar list = document.getElementById('book_list');\nvar bookArray = JSON.parse(localStorage.getItem('allBooks'));\n\n//# sourceURL=webpack://webpack-tutorial/./src/app/global_variables.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _buttons__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./buttons */ \"./src/app/table/buttons.js\");\n/* harmony import */ var _global_variables__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../global_variables */ \"./src/app/global_variables.js\");\n\n\nvar filterAuthor = document.querySelector('.filter_author');\nvar filterPriority = document.querySelector('.filter_priority');\nvar filterCategory = document.querySelector('.filter_category');\n\nvar filterArray = function filterArray(array, fields, value) {\n  fields = Array.isArray(fields) ? fields : [fields];\n  var newArray = array.filter(function (item) {\n    return fields.some(function (field) {\n      return item[field].includes(value);\n    });\n  });\n  _global_variables__WEBPACK_IMPORTED_MODULE_1__.list.innerHTML = '';\n\n  if (newArray.length > 0) {\n    newArray.map(function (book) {\n      var trElement = document.createElement('tr');\n      trElement.innerHTML = \" <td>\".concat(book.title, \"</td><td> \").concat(book.author, \"</td> <td>\").concat(book.category, \"</td> <td> \").concat(book.priority, \"</td>\");\n      _global_variables__WEBPACK_IMPORTED_MODULE_1__.list.append(trElement);\n      (0,_buttons__WEBPACK_IMPORTED_MODULE_0__.buttons)(book.id, trElement);\n    });\n  }\n\n  ;\n};\n\nfilterAuthor.addEventListener('change', function (e) {\n  filterArray(_global_variables__WEBPACK_IMPORTED_MODULE_1__.bookArray, ['author'], e.target.value);\n});\nfilterCategory.addEventListener('change', function (e) {\n  filterArray(_global_variables__WEBPACK_IMPORTED_MODULE_1__.bookArray, ['category'], e.target.value);\n});\nfilterPriority.addEventListener('change', function (e) {\n  filterArray(_global_variables__WEBPACK_IMPORTED_MODULE_1__.bookArray, ['priority'], e.target.value);\n});\n\n//# sourceURL=webpack://webpack-tutorial/./src/app/table/filter.js?");

/***/ }),

/***/ "./src/app/table/sort.js":
/*!*******************************!*\
  !*** ./src/app/table/sort.js ***!
  \*******************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _styles_main_scss__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./styles/main.scss */ \"./src/styles/main.scss\");\n\n\n__webpack_require__(/*! ./app/global_variables.js */ \"./src/app/global_variables.js\");\n\n__webpack_require__(/*! ./app/table/buttons.js */ \"./src/app/table/buttons.js\");\n\n__webpack_require__(/*! ./app/table/bookTable.js */ \"./src/app/table/bookTable.js\");\n\n__webpack_require__(/*! ./app/counter.js */ \"./src/app/counter.js\");\n\n__webpack_require__(/*! ./app/form/form.js */ \"./src/app/form/form.js\");\n\n__webpack_require__(/*! ./app/form/category_setting */ \"./src/app/form/category_setting.js\");\n\n__webpack_require__(/*! ./app/table/filter */ \"./src/app/table/filter.js\");\n\n__webpack_require__(/*! ./app/print */ \"./src/app/print.js\");\n\n__webpack_require__(/*! ./app/table/sort */ \"./src/app/table/sort.js\");\n\n//# sourceURL=webpack://webpack-tutorial/./src/index.js?");
...
/******/ 	(() => {
/******/ 		__webpack_require__.h = () => ("fb0f27e0aff1aa038708")
/******/ 	})();
/******/ 	
...
/******/ 	(() => {
/******/ 		__webpack_require__.p = "/book-list/";
/******/ 	})();
/******/ 	
